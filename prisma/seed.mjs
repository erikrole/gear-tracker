...
const badgeDefinitions = [
  ...
  },
  {
    key: "scan_50",
    name: "Scan Regular",
    description: "Completed 50 successful kiosk scans.",
    icon: "ScanSearch",
    category: BadgeCategory.SCAN,
    kind: BadgeKind.COUNT,
    trigger: "scan:success",
  ...
  },
  {
    key: "first_shift",
    name: "On Duty",
    description: "Worked a first event shift.",
    icon: "CalendarClock",
  ...
  },
  {
    key: "shift_10",
    name: "Shift Regular",
    description: "Worked ten event shifts.",
    icon: "CalendarDays",
    category: BadgeCategory.SHIFT,
    kind: BadgeKind.COUNT,
    trigger: "shift:completed",
  ...
  },
  {
    key: "shift_50",
    name: "Shift Veteran",
    description: "Worked 50 event shifts.",
    icon: "CalendarRange",
    category: BadgeCategory.SHIFT,
    kind: BadgeKind.COUNT,
    trigger: "shift:completed",
