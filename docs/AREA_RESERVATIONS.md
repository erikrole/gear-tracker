...
- 2026-03-24: **BookingDetailPage roadmap** — V1→V2→V3 progressive enhancement plan at `tasks/booking-detail-roadmap.md`. Covers event context, derived checkouts, scan visibility, inline editing, predictive features.
