...
- 2026-03-31: **Booking sheet deep links** — Same changes as AREA_CHECKOUTS. Reservation redirect page forwards all URL search params. Dashboard and item detail "Reserve" buttons deep-link to CreateBookingSheet with context.
