...
- Tests: `tests/bulk-unit-kiosk-scans.test.ts`, `tests/ios-kiosk-all-day-contract.test.ts`, `tests/ios-kiosk-checkout-details-polish.test.ts`, `tests/ios-kiosk-idle-cancellation.test.ts`, `tests/ios-kiosk-idle-sleep-mode.test.ts`, `tests/ios-kiosk-liquid-glass.test.ts`, `tests/ios-kiosk-reservation-pickup-contract.test.ts`, `tests/ios-kiosk-scanner-focus.test.ts`
