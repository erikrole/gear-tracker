...
- 2026-03-23: Unified Calendar page (V1) shipped. Events + Schedule merged into `/calendar`. Venue Mappings moved to `/settings/venue-mappings`. System roadmap updated — calendar merge is item #1 in V1 order.
