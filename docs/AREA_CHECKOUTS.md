...
- 2026-06-11: **Booking detail overlay responsive** -- BookingDetailsSheet now renders a shadcn Drawer on mobile viewports (< 768px) while keeping the side Sheet on desktop. Edit, Cancel, Start checkout, Open full booking, equipment edit, history, and retry behaviors are preserved in both overlay paths.
