...
## Change Log
- 2026-06-11: Kit delete confirmation now uses `AlertDialogAction variant="destructive"` via the shared shadcn prop instead of hand-written destructive Tailwind classes. Manual `bg-destructive text-destructive-foreground hover:bg-destructive/90` class string removed.
