...
- [x] [UI] **Stale — re-checked 2026-08-20 and already correct.** The dashboard error state reads `Couldn't load dashboard`, puts the underlying message in the description, and offers Retry (`HomeView.swift:181-186`). The generic "Error" label this finding described is gone.
