...
- [x] Slice 7 — Activation polish: tokens migration, brand overline, gradient numpad, active-slot underline.
- [x] Slice 8 — Sweep: one-off color grep, both schemes build, docs sync, archive this plan.
