...
- 2026-06-10: Firmware no longer renders as a nested card. The row shows only the compact installed-firmware badge and status; clicking the badge opens the modal with current firmware, newest firmware, checked date, release date, source link, and update actions.
