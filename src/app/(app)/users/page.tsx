  ...
  return (
    <>
      ...
      <div className="card mb-12">
        ...
        <form onSubmit={handleCreateUser} className="form-grid form-grid-5">
          ...
          <input name="password" type="password" minLength={8} placeholder="Temporary password" required className="form-input" />
          <select name="role" defaultValue="STAFF" className="form-select">
            <option value="ADMIN">Admin</option>
            <option value="STAFF">Staff</option>
            <option value="STUDENT">Student</option>
          </select>
          <select name="locationId" defaultValue="" className="form-select">
