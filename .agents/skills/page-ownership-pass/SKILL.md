...
This workflow now lives in `gt-page`.

1. Tell the user the legacy invocation is being handled by `gt-page`.
2. Read `.agents/skills/gt-page/SKILL.md` completely.
3. Continue with that workflow without loading a second page-execution process.
